...
public interface GetTodayMenuQuery {
    ...
    default WelstoryMenuResult refreshMenu(String cotNo, String hallNo, String cafeteriaName, java.time.LocalDate date) {
        return getMenu(cotNo, hallNo, cafeteriaName, date);
    }
